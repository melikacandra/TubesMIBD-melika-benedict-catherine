...
<html>
	<head>
		...
		<Link href="styleHomePeserta.css" type="text/css" rel="stylesheet">
	</head>
		...
		<div class="w3-card-0">
			...
			<div class="w3-row tengah">
			    ...
			    <div class="w3-third w3-center">
			      	<i class='fa fa-home'><a href="homePeserta.php"> Home</a></i>
			    </div>
			    <div class="w3-third w3-center">
			      	<i class='fa fa-road'><a href="track.php"> Track</a></i>
			    </div>
