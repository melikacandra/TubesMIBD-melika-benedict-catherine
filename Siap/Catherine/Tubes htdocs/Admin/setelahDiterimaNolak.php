...
<html>
	<head>
		<title>Stelah diterima (Mau nolak)</title>
		...
		<div class="isitengah">
			...
			<table id="t01">
				 ...
				 <tr>
				    ...
				    <td>
				    	<i class="fa fa-check biru"></i>&emsp;
				    	<button class="btn1" id="myBtn"><i class="fa fa-times biru"></i></button>

				    	<div id="myModal" class="modal">
						  	<div class="modal-content">
					   			<h3>Sebutkan alasan penolakan</h3>
					   			<br>
					    		<input type="text" name="keterangan" value="Transaksi Fiktif">
					    		<br><br>
					    		<p><a href="setelahDiterimaNolak.php"><button class="hijaubut">Kembali</button></a> <a href="tolakHasil.php"><button id="merahbut"> Tolak</button></a></p>
						  	</div>
						</div>
				    </td>
				    <td></td>
