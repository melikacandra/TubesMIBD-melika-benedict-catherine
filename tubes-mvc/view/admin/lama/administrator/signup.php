	...
	<div class="signup">
		...
		<form method="POST">
			<table>
				...
				<tr>
					<td>email</td>
					<td><input type="text" name="input_email_address"></td>
				</tr>
				<tr>
					<td>Kata Sandi</td>
				...
				<tr>
					...
					<td><input type="text" name="input_password_confirm"></td>
				</tr>
				<tr>
					<td>Alamat</td>
					<td><textarea style="resize:none" id="input_address" name="input_address" rows="4" cols="25"></textarea></td>
				</tr>
				<tr>
					<td>Kontak</td>
			...
			<a class="tanya_akun" href="">Sudah punya akun?</a>
		</form>
	</div>
</body>
</html>