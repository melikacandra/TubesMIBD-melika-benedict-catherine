...
<html>
	<head>
		<title>Setelah diterima (Mau nolak)</title>
				    ...
				    <td>
				    	...
				    	<div id="myModal" class="modal">
						  	<div class="modal-content">
					    		...
					    		<br><br>
					    		<p><a href="setelahDiterimaNolak.php"><button class="hijaubut">Kembali</button></a> <a href="simulasiTolak"><button id="merahbut"> Tolak</button></a></p>
						  	</div>
						</div>
				    </td>
				    <td></td>
